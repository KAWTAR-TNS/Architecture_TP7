...
<div style="border: 2px solid #333; padding: 10px; display: flex; gap: 10px; max-width: fit-content;">
  ...
  <img src="./docs/h2-1.png" alt="Console H2 - Vue 1" style="border: 1px solid #999; max-width: 300px;" />
  <img src="./docs/h2-2.png" alt="Console H2 - Vue 2" style="border: 1px solid #999; max-width: 300px;" />
...
<div style="border: 2px solid #333; padding: 10px; max-width: fit-content;">
  <img src="./docs/json.png" alt="JSON SoapUI" style="border: 1px solid #999; max-width: 600px;" />
</div>
